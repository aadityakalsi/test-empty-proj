...
if(WIN32)
  ...
  if (USE_CPP)
    if (USE_CPP11)
      set(STD_VER_FLAG -std=c++11)
    else()
      set(STD_VER_FLAG -std=c++03)
    endif(USE_CPP11)
  else()
    set(STD_VER_FLAG -std=c99)
  endif(USE_CPP)
  add_definitions(${STD_VER_FLAG} -Wall -Werror -fvisibility=hidden)
endif(WIN32)
...
function(add_lib tgt buildSym)
  add_library(${tgt} ${ARGV})
  get_target_property(compile_defs ${tgt} COMPILE_DEFINITIONS)
  if(compile_defs)
    set(compile_defs "${compile_defs} ${buildSym}")  
  else()
    set(compile_defs ${buildSym})
  endif(compile_defs)
